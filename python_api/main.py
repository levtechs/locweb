...
def process_area(client, lat, lng, area_name, keyword, goal_mode=False):
...
def run_with_goal(client, lat, lng, area_name, keyword, goal):
    print("\n" + "=" * 60)
    print(f"GOAL MODE: Generate {goal} websites")
    print("=" * 60)
    ...
    while current_count < target_count:
        ...
        success_count = process_area(client, lat, lng, area_name, keyword, goal_mode=True)
...
def main():
    ...
    if goal and goal > 0:
        ...
        run_with_goal(client, lat, lng, area_name, keyword, goal)
        print("\nDone!")
    else:
        while True:
            if lat_input and lng_input:
